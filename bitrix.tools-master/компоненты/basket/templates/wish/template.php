                        ...
                        <tbody class="xans-element- xans-order xans-order-list center">
                            ...
                            <tr class="xans-record-" data-id="<?=$items['ID']?>">
                                <td class="subject"><a href="<?=$items['PRODUCT']['FIELDS']['DETAIL_PAGE_URL']?>">
                                        <div class="thumb">
                                            <img src="<?=$items['PREVIEW_PICTURE']['SRC']?>" alt="<?=$items['PRODUCT']['FIELDS']['NAME']?>"/>
                                        </div>
                                ...
                                <td class="button" data-id="<?=$items['ID']?>">
                                    ...
                                    <a class="btnNormal btn-bask" data-js_basket="<?=$items['PRODUCT']['FIELDS']['ID']?>"><span class="icoWish">Корзина</span></a>
