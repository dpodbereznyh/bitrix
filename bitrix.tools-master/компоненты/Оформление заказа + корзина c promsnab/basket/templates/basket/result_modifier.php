...
foreach ($arResult["ITEMS"] as &$item) {
    ...
    $image['height'] = '100';
    $image['width']  = '100';
    if (empty($item['PRODUCT']['FIELDS']['DETAIL_PICTURE']) && !empty($item['PRODUCT']['FIELDS']['PREVIEW_PICTURE'])) {
        ...
        $image['src'] =CFILE::GetPath($item['PRODUCT']['FIELDS']['PREVIEW_PICTURE']);
    } elseif (!empty($item['PRODUCT']['FIELDS']['DETAIL_PICTURE'])) {
        ...
        $image['src'] =CFILE::GetPath($item['PRODUCT']['FIELDS']['DETAIL_PICTURE']);
    }
