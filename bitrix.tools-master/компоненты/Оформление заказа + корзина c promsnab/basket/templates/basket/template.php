...
console.log(<?=json_encode($arMeasure, JSON_UNESCAPED_UNICODE)?>,'basket');
</script><? 
...
<?if($items['PREVIEW_PICTURE']['SRC']=='/bitrix/components/bitrix/sale.basket.basket/templates/.default/images/no_photo.png'){continue;}?>
    ...
    <div class="table-row pc-label">
        ...
        <div class="td-weight ">
            <? $arMeasure = \Bitrix\Catalog\ProductTable::getCurrentRatioWithMeasure($items['PRODUCT']['FIELDS']['ID']); ?>
            <div class="mobile-label">Ед. изм.: </div>
            <? echo $arMeasure[$items['PRODUCT']['FIELDS']['ID']]['MEASURE']['SYMBOL_RUS']?>
    </div>
        <div class="td-weight "><div class="mobile-label">Вес (кг): </div>
        <?if(!empty($items['PRODUCT']['CATALOG']['WEIGHT'])):?><?=$items['PRODUCT']['CATALOG']['WEIGHT']/1000?><?endif?>
    </div>
        ...
        <?endforeach?>
            ...
            <div class="result-val">
               ...
               <div class="result-val__count"><span class="title">Количество товаров:</span><span class="value"><?=$arResult['QUANTITY']?></span></div>
               <div class="result-val__weight"><span class="title">Вес:</span><span class="value"><?=round($arResult['WEIGHT']/1000)?> кг.</span></div>
