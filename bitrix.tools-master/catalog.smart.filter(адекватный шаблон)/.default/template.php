				...
				<?foreach ($arResult["ITEMS"] as $key => $arItem) //prices
{
    ...
    if (isset($arItem["PRICE"])):
        ...
        ?>
							...
							<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"): ?> <?else: ?><?endif?> bx-filter-parameters-box <?if (!empty($arItem["VALUES"]["MIN"]["HTML_VALUE"]) || !empty($arItem["VALUES"]["MAX"]["HTML_VALUE"])) {
        echo 'infilter';
    }
    ?>
							">
							<span class="bx-filter-container-modef"></span>
							<div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)"><span><?=$arItem["NAME"]?> <i data-role="prop_angle" class="fa fa-angle-down"></i></span></div>
							<div class="bx-filter-block" data-role="bx_filter_block">
								<div class="filter-row bx-filter-parameters-box-container">
									...
									<div class=" bx-filter-parameters-box-container-block bx-left">
										...
										<div class="bx-filter-input-container">
											...
											<input
												...
												value="<?=(!empty($arItem["VALUES"]["MIN"]["HTML_VALUE"]) ? $arItem["VALUES"]["MIN"]["HTML_VALUE"] : str_replace(' ', '', $prices[0]))?>"
												size="5"
									...
									<div class=" bx-filter-parameters-box-container-block bx-right">
										...
										<div class="bx-filter-input-container">
											...
											<input
												...
												value="<?=(!empty($arItem["VALUES"]["MIN"]["HTML_VALUE"]) ? $arItem["VALUES"]["MAX"]["HTML_VALUE"] : str_replace(' ', '', $prices[$step_num]))?>"
												size="5"
												onkeyup="smartFilter.keyup(this)"
												readonly
											/>
...
foreach ($arResult["ITEMS"] as $key => $arItem) {
    ...
    if ($arItem['PROPERTY_TYPE'] == 'L') {
        ...
        foreach ($arItem['VALUES'] as $value) {
            $flagExp = ($value['CHECKED'] == true);
            if ($flagExp) {
                break;
            }
        }} else {
        $flagExp = ($arItem["DISPLAY_EXPANDED"] == 'Y');
    }

    ?>
					<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"): ?> <?else: ?><?endif?> bx-filter-parameters-box <?if ($flagExp): ?>infilter<?endif?>">
						<span class="bx-filter-container-modef"></span>
    ...
    switch ($arItem["DISPLAY_TYPE"]) {
        ...
        case "P": //DROPDOWN
            ...
            ?>
												...
												<div class="bx-filter-select-arfilter-row"></div>
												<input
													style="display: none"
													type="radio"
